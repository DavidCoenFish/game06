...
class UiInstanceCharacter : public DscUi::IUiInstance
{
public:
    enum class TUiNodeGroupDataSource : uint8
    {
        TBack = static_cast<uint8>(DscUi::TUiNodeGroupDataSource::TCount),
        TCount
    };


    UiInstanceCharacter() = delete;
    UiInstanceCharacter& operator=(const UiInstanceCharacter&) = delete;
    UiInstanceCharacter(const UiInstanceCharacter&) = delete;
