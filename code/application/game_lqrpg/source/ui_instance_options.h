...
class UiInstanceOptions : public DscUi::IUiInstance
{
public:
    ...
    UiInstanceOptions() = delete;
    UiInstanceOptions& operator=(const UiInstanceOptions&) = delete;
    UiInstanceOptions(const UiInstanceOptions&) = delete;
