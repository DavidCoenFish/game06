...
class UiInstanceCombat : public DscUi::IUiInstance
{
public:
    ...
    UiInstanceCombat() = delete;
    UiInstanceCombat& operator=(const UiInstanceCombat&) = delete;
    UiInstanceCombat(const UiInstanceCombat&) = delete;
