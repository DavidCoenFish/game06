...
#if defined(_DEBUG)
template <>
const DscDag::DagNodeGroupMetaData& DscDag::GetDagNodeGroupMetaData(const UiInstanceCombat::TUiNodeGroupDataSource in_value)
{
    ...
    default:
        ...
        break;
    case UiInstanceCombat::TUiNodeGroupDataSource::TBack:
    {
...
const std::string UiInstanceCombat::GetTemplateName()
{
    return "combat";
}

DscDag::NodeToken UiInstanceCombat::BuildDataSource(
...
)
{
    ...
    auto result = in_dag_collection.CreateGroupEnum<UiInstanceCombat::TUiNodeGroupDataSource, DscUi::TUiNodeGroupDataSource>(in_data_source_owner);
...
std::shared_ptr<DscUi::IUiInstance> UiInstanceCombat::Factory(
    const DscUi::UiInstanceFactory<UiInstanceContext>& in_ui_instance_factory,
    const UiInstanceContext& in_context
)
{
    std::shared_ptr<DscUi::IUiInstance> result = std::make_shared<UiInstanceCombat>(
...
UiInstanceCombat::UiInstanceCombat(
    const DscUi::UiInstanceFactory<UiInstanceContext>& in_ui_instance_factory,
    const UiInstanceContext& in_context
)
...
void UiInstanceCombat::Update()
{
}

DscDag::NodeToken UiInstanceCombat::GetDagUiGroupNode()
{
    return _main_node_group;
}

DscDag::NodeToken UiInstanceCombat::GetDagUiDrawNode()
{
    return DscDag::DagNodeGroup::GetNodeTokenEnum(_main_node_group, DscUi::TUiNodeGroup::TDrawNode);
}

DscDag::NodeToken UiInstanceCombat::GetDagUiDrawBaseNode()
{
