...
)
{
	...
	DSC_DEBUG_ONLY(DscDag::DebugSetNodeName(dag_node_restored, "dag_node_restored");)
	...
	DSC_DEBUG_ONLY(DscDag::DebugSetNodeName(dag_node_screen_size, "dag_node_screen_size");)
	...
	)
{
	...
	DscDag::SetValueType<int32>(_dag_node_restored, 0);
	return;
}
	...
	)
{
	...
	DscDag::SetValueType(_dag_node_screen_size, in_size);
	return;
}
