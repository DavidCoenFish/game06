...
{
public:
	IWindowApplication(const HWND in_hwnd, const bool in_full_screen, const int in_defaultWidth, const int in_defaultHeight);
	...
	const int GetDefaultHeight() const { return _defaultWidth; }
